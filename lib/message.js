const { decodeJid, getBuffer, writeExifWebp, isUrl } = require("wa-bot-functions");
const fileType = require("file-type");
const Base = require("./base");
const config = require("../config");
const ReplyMessage = require("./reply_message");
...
class Message extends Base {
    ...
    _patch(data) {
        ...
        ? data.messageTimestamp.low: data.messageTimestamp;
    ...
    async sendMessage(
        content,
        opt = {
            packname: "CLASH-WA-BOT", author: "TOXIC-KICHUX"
        },
        type = "text"
    ) {
